...
% For appendix to be printed as "Appendix A {name of appendix}" 
% isntead of "A {name of appendix}"
\makeatletter
...
\tableofcontents
\newpage
\section{Introduction and Design Background} \label{sect:intro}
...
\subsection{bq2057CTS Battery Management Calcs}
...
%   &= \left(5.2 - 0.3 - 0.176 - 3) \cdot 0.88 \\
%   &= 1.517 W
% \end{align}
